...
def My_Informer():
    ...
    len_columns = int(paras['len_columns'].values[0])

    parser = argparse.ArgumentParser(description='[Informer] Long Sequences Forecasting')

    parser.add_argument('--model', type=str, required=None, default='informer',
                        help='model of experiment, options: [informer, informerstack, informerlight(TBD)]')
    parser.add_argument('--data', type=str, required=None, default='ETTh1', help='data')
    ...
    data_parser = {'ETTh1': {'data': 'ETTh1.csv', 'T': 'OT', 'M': [7, 7, 7], 'S': [1, 1, 1],
                             'MS': [len_columns, len_columns, 1]}}
